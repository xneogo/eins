...
type Statement func(field string, value interface{}) (ZSqlizer, error)

var OpOp = map[string]Statement{
	opEq: func(field string, value interface{}) (ZSqlizer, error) {
		return squirrel.Eq{field: value}, nil
	},
	opNe1: func(field string, value interface{}) (ZSqlizer, error) {
		return squirrel.NotEq{field: value}, nil
	},
	opNe2: func(field string, value interface{}) (ZSqlizer, error) {
		return squirrel.NotEq{field: value}, nil
	},
	opIn: func(field string, value interface{}) (ZSqlizer, error) {
		if reflect.ValueOf(value).Kind() == reflect.Slice {
			return squirrel.Eq{field: value}, nil
		}
		return squirrel.Eq{}, ErrNotASliceValueForInStatement
	},
	opNotIn: func(field string, value interface{}) (ZSqlizer, error) {
		if reflect.ValueOf(value).Kind() == reflect.Slice {
			return squirrel.NotEq{field: value}, nil
		}
		return squirrel.NotEq{}, ErrNotASliceValueForInStatement
	},
	opBetween: func(field string, value interface{}) (ZSqlizer, error) {
	...
	opNotBetween: func(field string, value interface{}) (ZSqlizer, error) {
		if reflect.ValueOf(value).Kind() == reflect.Slice && reflect.ValueOf(value).Len() == 2 {
	...
	opGt: func(field string, value interface{}) (ZSqlizer, error) {
		return squirrel.Gt{field: value}, nil
	},
	opGte: func(field string, value interface{}) (ZSqlizer, error) {
		return squirrel.GtOrEq{field: value}, nil
	},
	opLt: func(field string, value interface{}) (ZSqlizer, error) {
		return squirrel.Lt{field: value}, nil
	},
	opLte: func(field string, value interface{}) (ZSqlizer, error) {
		return squirrel.LtOrEq{field: value}, nil
	},
	opLike: func(field string, value interface{}) (ZSqlizer, error) {
		return squirrel.Like{field: value}, nil
	},
	opNotLike: func(field string, value interface{}) (ZSqlizer, error) {
		return squirrel.NotLike{field: value}, nil
	},
	opNull: func(field string, value interface{}) (ZSqlizer, error) {
